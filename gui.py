...
class TSPGUI:
    """
    GUI for solving the Traveling Salesman Problem (TSP) using the Ant Colony Optimization (ACO) algorithm.
    """
    def __init__(self, master: tk.Tk) -> None:
        ...
        Args:
        master (tk.Tk): The root window object.
        """
        self.master = master
    ...
    def perform_calculation(self, event: tk.Event | None = None) -> None:
    ...
    def update_plot(self) -> None:
        """Update the matplotlib plot with the current TSP solution."""
        if self.tsp:
            self.ax.clear()
